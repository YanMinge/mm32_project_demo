...
{
    WRITE_REG(tim->DCR, dma_base | length);
}
////////////////////////////////////////////////////////////////////////////////
...
void TIM_ETRClockMode1Config(TIM_TypeDef* tim, TIMEXTTRGPSC_Typedef psc, TIMETP_Typedef polarity, u16 filter)
{
    ...
    MODIFY_REG(tim->SMCR, TIM_SMCR_TS | TIM_SMCR_SMS, TIM_TS_ETRF | TIM_SlaveMode_External1);
}
...
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void exTIM_SetIC1Plority(TIM_TypeDef* tim, TIMICP_Typedef pol)
{
...
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void exTIM_SetIC2Plority(TIM_TypeDef* tim, TIMICP_Typedef pol)
{
...
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void exTIM_SetIC3Plority(TIM_TypeDef* tim, TIMICP_Typedef pol)
{
...
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void exTIM_SetIC4Plority(TIM_TypeDef* tim, TIMICP_Typedef pol)
{
...
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void exTIM_SetCompare5(TIM_TypeDef* tim, u32 compare)
{
...
////////////////////////////////////////////////////////////////////////////////
u32 exTIM_GetCapture5(TIM_TypeDef* tim)
{
    return tim->CCR5;
}
...
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void exTIM_OC5Init(TIM_TypeDef* tim, TIM_OCInitTypeDef* init_struct)
{
...
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void exTIM_OC5PreloadConfig(TIM_TypeDef* tim, TIMOCPE_Typedef preload)
{
...
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void exTIM_OC5PolarityConfig(TIM_TypeDef* tim, TIMCCxP_Typedef polarity)
{
...
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void exTIM_OC5FastConfig(TIM_TypeDef* tim, TIMOCFE_Typedef fast)
{
...
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void exTIM_ClearOC5Ref(TIM_TypeDef* tim, TIMOCCE_Typedef clear)
{
...
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void exTIM_DirectOutput(TIM_TypeDef* tim, FunctionalState state)
{
