...
void GPIO_DeInit(GPIO_TypeDef* gpio)
{
    switch (*(u32*)&gpio) {
        case (u32)GPIOA:
            ...
            break;
        //COMMON_DisableIpClock(emCLOCK_GPIOA);  break;
        case (u32)GPIOB:
            RCC_AHBPeriphClockCmd(RCC_AHBENR_GPIOB, DISABLE);
            break;
        //COMMON_DisableIpClock(emCLOCK_GPIOB);  break;
        case (u32)GPIOC:
            RCC_AHBPeriphClockCmd(RCC_AHBENR_GPIOC, DISABLE);
            break;
        //COMMON_DisableIpClock(emCLOCK_GPIOC);  break;
        case (u32)GPIOD:
            RCC_AHBPeriphClockCmd(RCC_AHBENR_GPIOD, DISABLE);
            break;
        //COMMON_DisableIpClock(emCLOCK_GPIOD);  break;
        default:
            break;
    }
}
