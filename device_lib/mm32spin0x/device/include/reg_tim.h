...
////////////////////////////////////////////////////////////////////////////////
#define TIM1_BASE                       (0x40010000UL + 0x2C00)              ///< Base Address: 0x40012C00
#define TIM2_BASE                       (0x40000000UL + 0x0000)              ///< Base Address: 0x40000000
#define TIM3_BASE                       (0x40000000UL + 0x0400)              ///< Base Address: 0x40000400



#define TIM14_BASE                      (0x40010000UL + 0x4000)              ///< Base Address: 0x40014000

#define TIM16_BASE                      (0x40010000UL + 0x4400)              ///< Base Address: 0x40014400
#define TIM17_BASE                      (0x40010000UL + 0x4800)              ///< Base Address: 0x40014800
