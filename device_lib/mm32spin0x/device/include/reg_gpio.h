...
#define GPIOA_BASE                  (0x48000000UL + 0x0000)                  ///< Base Address: 0x48000000
#define GPIOB_BASE                  (0x48000000UL + 0x0400)                  ///< Base Address: 0x48000400

#define GPIOC_BASE                  (0x48000000UL + 0x0800)                  ///< Base Address: 0x48000800
#define GPIOD_BASE                  (0x48000000UL + 0x0C00)                  ///< Base Address: 0x48000C00
